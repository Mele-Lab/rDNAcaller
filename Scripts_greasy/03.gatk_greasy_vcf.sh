...
bcftools annotate \
    	...
    	${TMPDIR}/${sample}.${ploidy}.g.vcf.gz > ${TMPDIR}/${sample}.${ploidy}_filtering.g_wo_PL.vcf
...
rm ${TMPDIR}/${sample}.${ploidy}.g.vcf.gz ${TMPDIR}/${sample}.${ploidy}_filtering.g_wo_PL.vcf ${TMPDIR}/${sample}.${ploidy}_trim.vcf.gz 
